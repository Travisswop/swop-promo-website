...
//       {/* Only show this section for desktop */}
...
//       {/* Only show this section for mobile */}
...
//       <div className='grid grid-cols-1 md:grid-cols-3 items-center gap-4 md:gap-14 mt-[-60px] md:mt-[-330px]'>
