      ...
      <div className={cn("h-full w-full  z-10", poppins.className)}>
        <section className=" grid grid-cols-1 gap-10 py-0  rounded-2xl ">
          <ScrollMotionEffect
            ...
            duration="2000"
            className={cn(
              "w-full h-[550px] lg:h-[650px] flex flex-col gap-5  justify-start  items-center relative rounded-3xl py-12 lg:py-14 bg-[url('/assets/hardware/collection/blackBg.png')] bg-cover bg-no-repeat object-cover bg-center",
            ...
            <div className="text-center text-white text-xl md:text-2xl flex flex-col justify-center items-center   font-light relative ">
              <div className="transition-all duration-300 ease-in-out cursor-pointer scale-125  mb-5">
                <Image
                  ...
                  quality={100}
                  priority
                  className="  animate-slow-bounce w-[50px] lg:w-[80px]  "
                />
              </div>
              ...
              <p className="text-base md:text-lg text-gray-400 pt-4 pb-5 md:pb-0 text-center">
                Coming Soon
              </p>
            </div>
            <ScrollMotionEffect
